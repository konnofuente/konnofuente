...
const Hero = () => {
  ...
  return (
    <div className=" sm:flex items-center sm:justify-between bg-secondaryNormal md:px-5 lg:px-28 md:py-32 py-16 px-2  gap-10 md:gap-5">
      <div className="flex flex-col sm:items-start justify-center items-center gap-5 lg:w-2/5 ">
       ...
       <div className="flex flex-wrap md:flex-row  lg:flex-nowrap  sm:justify-between gap-5 md:gap-5 items-start w-full mb-10 md:mb-0">
        <div className="w-full md:w-[45%] lg:w-[100%] mb-2 " >
